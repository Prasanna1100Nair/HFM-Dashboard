...
public class ColorTemplate {
    ...
    public static final int[] VORDIPLOM_COLORS_SAMPLE = {
            Color.rgb(126, 216, 56), Color.rgb(229, 214, 10), Color.rgb(242, 155, 26),
            Color.rgb(24, 197, 240), Color.rgb(246, 94, 115)
    };
