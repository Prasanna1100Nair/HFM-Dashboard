    ...
    public static List<Entry> loadEntriesFromFile(String path) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new Entry(Integer.parseInt(split[0]), Integer.parseInt(split[1])));
                } else {
    ...
    public static List<Entry> loadEntriesFromAssets(AssetManager am, String path) {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new Entry(Integer.parseInt(split[1]), Float.parseFloat(split[0])));
                } else {
    ...
    public static List<BarEntry> loadBarEntriesFromAssets(AssetManager am, String path) {
        ...
        try {
            ...
            while (line != null) {
                ...
                entries.add(new BarEntry(Integer.parseInt(split[1]), Float.parseFloat(split[0])));
